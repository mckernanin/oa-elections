...
class OA_Elections_Fields {
	...
	public function load_fields() {
		add_action( 'cmb2_init', array( $this, 'unit_metaboxes' ) );
	}
	...
	static function get( $field_name = null, $id = null ) {
		...
		if ( false === strpos( $field_name, '_oa_' ) ) {
			$field_name = '_oa_' . $field_name;
		}
	 ...
	 */
	public function unit_metaboxes() {
		...
		$cmb->add_field( array(
			...
			'options' => array(
				''                 => '---',
				'white-eagle'      => __( 'Arapahoe / White Eagle', 'OA-Elections' ),
				'medicine-pipe'    => __( 'Centennial / Medicine Pipe', 'OA-Elections' ),
				'white-buffalo'    => __( 'Frontier / White Buffalo', 'OA-Elections' ),
				'kodiak'           => __( 'Gateway / Kodiak', 'OA-Elections' ),
				'spirit-eagle'     => __( 'Pioneer Trails / Spirit Eagle', 'OA-Elections' ),
				'running-antelope' => __( 'Timberline / Running Antelope', 'OA-Elections' ),
				'medicine-bear'    => __( 'Valley / Medicine Bear', 'OA-Elections' ),
			),
		) );
